...
import ca.sheridancollege.barlasc.database.StoreDatabase;
...
@Autowired
@Lazy
private StoreDatabase da;

public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
// Find the user based on the username (read email)
ca.sheridancollege.barlasc.beans.User user = da.findUserAccounts(username);
